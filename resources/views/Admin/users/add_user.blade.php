                            ...
                            <div class="col">
                                <div class="control-group form-group">
                                    ...
                                    <input type="text" class="form-control required" placeholder="اسم المستخدم" name="name"
                                        data-bs-placement="bottom" data-bs-toggle="tooltip" title="يرجى ادخال اسم المستخدم"
                                        required="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="control-group form-group">
                                    ...
                                    <input type="email" class="form-control required" placeholder="example@gmail.com"
                                        name="email" data-bs-placement="bottom" data-bs-toggle="tooltip"
                                        title="يرجى ادخال البريد الإلكتروني" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
