                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="inputName" name="product_name_ar"
                                            value="{{ old('product_name_ar') ?? $product->translate('ar')->product_name }}"
                                            data-bs-placement="bottom" data-bs-toggle="tooltip"
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="inputName" name="product_name_en"
                                            value="{{ old('product_name_en') ?? $product->translate('en')->product_name }}"
                                            data-bs-placement="bottom" data-bs-toggle="tooltip"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" id="arabic_description" name="description_ar"
                                            value="{{ old('description_ar') ?? $product->translate('ar')->description }}"
                                            data-bs-placement="bottom" data-bs-toggle="tooltip" rows="3"
                                            placeholder="وصف المنتج هنا ...."></textarea>
                                    </div>

                                    <div class="col">
                                        <label for="exampleTextarea">وصف المنتج باللغة الإنجليزية</label>
                                        <textarea class="form-control" id="english_description" name="description_en"
                                            value="{{ old('description_en') ?? $product->translate('en')->description }}"
                                            data-bs-placement="bottom" data-bs-toggle="tooltip" rows="3"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                type="number" id="max_price" name="max_price"
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                type="number" id="min_price" name="min_price"
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                type="number" id="decreasing_value" name="decreasing_value"
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                ...
                                                data-bs-placement="bottom" data-bs-toggle="tooltip"
                                                title="يرجى ادخال الكمية المتاحة من هذا المنتج">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="hidden" name="return_option" value="0">
