                        ...
                        <a class="wrapper w-100 ms-3" href="#">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <small class="text-muted ms-auto">30 ago mins</small>
                                    <p class="mb-0"></p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="list d-flex align-items-center border-bottom p-3">
                        ...
                        <a class="wrapper w-100 ms-3" href="#">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="mdi mdi-clock text-muted me-1"></i>
                                    <small class="text-muted ms-auto">4 ago hours</small>
                                    <p class="mb-0"></p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="list d-flex align-items-center border-bottom p-3">
                        ...
                        <a class="wrapper w-100 ms-3" href="#">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="mdi mdi-clock text-muted me-1"></i>
                                    <small class="text-muted ms-auto">1 ago day</small>
                                    <p class="mb-0"></p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="list d-flex align-items-center border-bottom p-3">
                        ...
                        <a class="wrapper w-100 ms-3" href="#">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="mdi mdi-clock text-muted me-1"></i>
                                    <small class="text-muted ms-auto">45 ago minutes</small>
                                    <p class="mb-0"></p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="list d-flex align-items-center p-3">
                        ...
                        <a class="wrapper w-100 ms-3" href="#">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="mdi mdi-clock text-muted me-1"></i>
                                    <small class="text-muted ms-auto">2 ago days</small>
                                    <p class="mb-0"></p>
                                </div>
                            </div>
                        </a>
