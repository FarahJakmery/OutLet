...
@section('web_content')
        ...
        <div class="container">
            <div class="header-container">
                ...
                <div class="side-bar">
                    ...
                    <a href="#">
                        <img src="{{ URL::asset('Web/assets/img/icon/ammerica.png') }}" alt="">
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row collection-small">
                <div class="collection-group collection-one col-md-5 col-xs-12">
                    ...
                    <img src="{{ URL::asset('Web/assets/img/collection01.png') }}" alt="">
                </div>
                <div class="collection-group  collection-two col-md-3 col-xs-6">
                    <img src="{{ URL::asset('Web/assets/img/collectio02.png') }}" alt="">
                    <div class="overlay-black"></div>
                    <div class="text-on">
                        <h3>قمصان أساسية</h3>
                        <h3>$29.99</h3>
                ...
                <div class="collection-group  collection-three col-md-3 col-xs-6">
                    <div class="overlay-black"></div>
                    <img src="{{ URL::asset('Web/assets/img/collection03.png') }}" alt="">
                    <div class="text-on">
                        <h3>اشترِ هذا </h3>
                        <h3>الصيف</h3>
                        <a>عرض المجموعة</a>
        ...
        <div class="container">
            <div class="row bag-offer-small">
                <div class="bag2 col-sm-6">
                    <img src="{{ URL::asset('Web/assets/img/bag-offer02.png') }}" alt="">
                    <div class="bag-info">
                        <p>اشترِ حقيبتين و </p>
                ...
                <div class="col-sm-6 bag1">
                    <img src="{{ URL::asset('Web/assets/img/bag-offer01.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="gallery-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <a href="#">
                                <img class="Dark" src="{{ URL::asset('Web/assets/img/summer-01.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                        ...
                        <div class="swiper-slide">
                            <span class="offer">30%</span>
                            <a href="#">
                                <img class="White" src="{{ URL::asset('Web/assets/img/summer-02.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                                <p>T-shirt Summer Vibes</p>
                        ...
                        <div class="swiper-slide">
                            <span class="offer">30%</span>
                            <a href="#">
                                <img class="Yellow" src="{{ URL::asset('Web/assets/img/summer-03.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                                <p>T-shirt Summer Vibes</p>
                        ...
                        <div class="swiper-slide">
                            <span class="offer">30%</span>
                            <a href="#">
                                <img class="Dark" src="{{ URL::asset('Web/assets/img/summer-04.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                                <p>T-shirt Summer Vibes</p>
                        ...
                        <div class="swiper-slide">
                            <span class="offer">30%</span>
                            <a href="#">
                                <img class="White" src="{{ URL::asset('Web/assets/img/summer-05.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                                <p>T-shirt Summer Vibes</p>
                        ...
                        <div class="swiper-slide">
                            <span class="offer">30%</span>
                            <a href="#">
                                <img class="White" src="{{ URL::asset('Web/assets/img/summer-06.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                                <p>T-shirt Summer Vibes</p>
                        ...
                        <div class="swiper-slide">
                            <span class="offer">30%</span>
                            <a href="#">
                                <img class="Yellow" src="{{ URL::asset('Web/assets/img/summer-07.png') }}"
                                    alt="">
                            </a>
                            <div class="info-collec">
                                <p>T-shirt Summer Vibes</p>
                ...
                <div class="fashion-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="sale-row">
                                <div class="side-two">
                                    <img src="{{ URL::asset('Web/assets/img/fashion-sale02.png') }}" alt="">
                                </div>
                                <div class="side-one">
                                    <img src="{{ URL::asset('Web/assets/img/fashion-sale01.png') }}" alt="">
                                </div>
                                <div class="sale-info">
                                    <h3>ارتديها</h3>
                                    <h5>بطريقتك</h5>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="sale-row">
                                ...
                                <div class="side-one">
                                    <img src="{{ URL::asset('Web/assets/img/summer-sale-01.jfif') }}" alt="">
                                </div>
                            </div>
                            <!-- </div> -->
                        </div>
                ...
                <div class="brand-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide item">
                            <img src="{{ URL::asset('Web/assets/img/BullBear.png') }}" alt="">
                            <div class="logo">
                                <img src="{{ URL::asset('Web/assets/img/pullBear-logo.png') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide item">
                            <img src="{{ URL::asset('Web/assets/img/stradeVius.png') }}" alt="">
                            <div class="logo">
                                <img src="{{ URL::asset('Web/assets/img/strade-logo.png') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide item">
                            <img src="{{ URL::asset('Web/assets/img/Zara.png') }}" alt="">
                            <div class="logo">
                                <img src="{{ URL::asset('Web/assets/img/zara-logo.png') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide item">
                            <img src="{{ URL::asset('Web/assets/img/HM.png') }}" alt="">
                            <div class="logo">
                                <img src="{{ URL::asset('Web/assets/img/HM-logo.png') }}" alt="">
                            </div>
                        </div>
                    </div>
    ...
    <div class="instagram padbtm40">
        <div class="insta-imgs">
            <img src="{{ URL::asset('Web/assets/img/instagram-1.png') }}" alt="">
            <img src="{{ URL::asset('Web/assets/img/instagram-2.png') }}" alt="">
            <img src="{{ URL::asset('Web/assets/img/instagram-3.png') }}" alt="">
            <img src="{{ URL::asset('Web/assets/img/instagram-4.png') }}" alt="">
            <img src="{{ URL::asset('Web/assets/img/instagram-5.png') }}" alt="">
            <img src="{{ URL::asset('Web/assets/img/instagram-6.png') }}" alt="">
            <img src="{{ URL::asset('Web/assets/img/instagram-7.png') }}" alt="">
        </div>
